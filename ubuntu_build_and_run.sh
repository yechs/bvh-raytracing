...
if [ "$1" = "--help" ]; then
    ...
    g++ -Werror=vla -fno-strict-aliasing -O$OPTARG -g -std=c++11 -Wall -Wextra -Werror=vla -Wno-format-security -Wno-misleading-indentation -Wno-char-subscripts -Wno-conversion -Wno-write-strings -Wno-missing-field-initializers -o executable.exe bvh.cpp -lglfw -lGL
